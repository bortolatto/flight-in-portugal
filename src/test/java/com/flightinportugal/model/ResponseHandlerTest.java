...
class ResponseHandlerTest {
    ...
    void getPriceAverageForBaggages() {
        ...
        bagPriceFlight1.setPriceForTwoBaggages(17);
        ...
        bagPriceFlight2.setPriceForTwoBaggages(12);
        ...
        bagPriceFlight3.setPriceForTwoBaggages(15);
    ...
    void buildResponse() {
        ...
        when(bagsAverageMock.getOneBagagge()).thenReturn(12.0);
        when(bagsAverageMock.getTwoBaggages()).thenReturn(17.0);
        ...
        String expectedUrl = "{\"priceAverage\":\"40\",\"bagsAverage\":{\"oneBagagge\":\"10\",\"twoBaggages\":\"17\"},\"dateFrom\":\"01/01/2020\",\"sourceAirport\":\"OPO\",\"targetAirport\":\"LIS\",\"partner\":\"TAP\",\"currency\":\"EUR\"}";
